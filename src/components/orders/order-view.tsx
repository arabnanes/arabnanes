    ...
    <div className="max-w-[1280px] mx-auto mb-14 lg:mb-16">
      ...
      <div className="w-full mx-auto shadow-sm">
        ...
        <div className=" mb-5">
          ...
          <div>
          <textarea placeholder="Write Your Comment" className="mt-5 resize-none border-black	border-solid	rounded	border-2	p-5" name="" id="" cols="30" rows="5"></textarea>
          </div>
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
             Confirm
          </button>
        </div>
        {/* end of Rate your order  */}
